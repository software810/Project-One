...
public class ScreenPanel extends JPanel implements ActionListener {
	...
	/* 
	It has a default constructor which initialises the screen panel.
	The initScreenPanel method loads the icons and starts the snake game by creating an apple and the snake parts.
	The action events on the screen move the snake based on the current location of the snake and apple.
	If the collision happens,the number of snake parts increase. If the snake hits the walls, the game is over. 
	 */
